...
composer.action(/^accept (.+)/g, async ctx => {
    ...
    await ctx.telegram.sendPhoto(info['from_id'], info['photo_id'], {
    ...
    await ctx.telegram.editMessageText(env.CONFESSION, info['replaced_message_id'], null,
        changedMessage({
